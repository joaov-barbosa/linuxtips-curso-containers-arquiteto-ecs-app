module "service" {
  ...
  source = "https://github.com/joaov-barbosa/linuxtips-curso-containers-arquiteto-ecs-service-module?ref=v1"
  region                      = var.region
  ...
  service_listener            = data.aws_ssm_parameter.listener.value #module.network.listener_out 
